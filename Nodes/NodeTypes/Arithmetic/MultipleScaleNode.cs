...
{
    public class MultipleScaleNode : Node
    {
        public MultipleScaleNode(Guid id, Control panel, ListView varwatch)
            : base(id, panel, varwatch)
        {
            this.Name = "MultipleScale";
        }

        public override void Draw(Point Location)
        {
            base.Draw(Location, HYDRA.Properties.Resources.MultipleScale);
        }
