...
{
    public class StandardDeviationNode : Node
    {
        public StandardDeviationNode(Guid id, Control panel, ListView varwatch)
        ...
        {
            base.Draw(Location, HYDRA.Properties.Resources.StandardDeviation);
        }
